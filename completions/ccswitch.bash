...
_ccswitch() {
    ...
    local commands="add rm ls sw to profile dir auto resume-mode rate-check rate-setup run check status stats version help -n -r --dry-run --restart --no-restart --resume --fork-session --no-fork-session"
